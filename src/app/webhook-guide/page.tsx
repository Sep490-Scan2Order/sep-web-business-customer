        ...
        <main className="mx-auto w-full max-w-5xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
          ...
          <section className="rounded-2xl border border-sky-200 bg-sky-50 p-5 shadow-sm sm:p-6">
            ...
            <ol className="mt-4 list-decimal space-y-3 pl-5 text-sm text-slate-700">
              <li>
                <span className="font-medium">Bắn webhooks khi:</span> Có tiền
                vào.
              </li>
              <li>
                <span className="font-medium">Điều kiện:</span> Chọn khi tài
                khoản ngân hàng là tài khoản đã được liên kết ở Sepay. Bỏ qua
                nếu nội dung giao dịch không có code thanh toán: Có.
              </li>
              <li>
                ...
                Bấm nút{" "}
                <span className="font-medium">
                  Gọi lại webhooks khi HTTP Status Code không nằm trong phạm vi
                  từ 200 đến 299
                </span>
                .
              </li>
          ...
          <section className="rounded-2xl border border-emerald-200 bg-emerald-50 p-5 shadow-sm sm:p-6">
            ...
            <p className="mt-2 text-sm text-slate-700">
              Sau khi lưu cấu hình, bạn sẽ thấy trạng thái webhook đã sẵn sàng
              hoạt động như minh họa bên dưới.
            </p>
