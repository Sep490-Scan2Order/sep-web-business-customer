  ...
  return (
    <main className="mx-auto w-full max-w-5xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
        <h2 className="text-lg font-semibold text-slate-900">1) Giao diện webhook trên Sepay</h2>
      ...
      <section className="rounded-2xl border border-sky-200 bg-sky-50 p-5 shadow-sm sm:p-6">
        <h2 className="text-lg font-semibold text-slate-900">2) Điền cấu hình webhook quan trọng</h2>
        <ol className="mt-4 list-decimal space-y-3 pl-5 text-sm text-slate-700">
          ...
          <li>
            <span className="font-medium">Điều kiện:</span> Chọn khi tài khoản ngân hàng là tài khoản đã được liên kết ở Sepay.
          ...
          <li>
            ...
            .
            <br />
            <span className="font-medium">Là webhooks xác thực thanh toán:</span> Đúng.
            <br />
            Bấm nút <span className="font-medium">Gọi lại webhooks khi HTTP Status Code không nằm trong phạm vi từ 200 đến 299</span>.
          </li>
          <li>
      ...
      <section className="rounded-2xl border border-emerald-200 bg-emerald-50 p-5 shadow-sm sm:p-6">
        <h2 className="text-lg font-semibold text-slate-900">3) Hoàn thành cấu hình webhook</h2>
        <p className="mt-2 text-sm text-slate-700">
          Sau khi lưu cấu hình, bạn sẽ thấy trạng thái webhook đã sẵn sàng hoạt động như minh họa bên dưới.
        </p>
